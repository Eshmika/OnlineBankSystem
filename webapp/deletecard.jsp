...
<title>Cancel the bank card</title>
				...
				<form action="deleteCard" method="post">
					<table style="width: 100%">
						<tr class="tabhei">
							...
							<td><c:forEach var="card" items="${cardDetails}">
									<input type="text" name="cardnum" value="${card.cardnumber}"
										readonly>
								</c:forEach></td>
						</tr>
						...
						<tr class="tabhei">
							<td style="background-color: rgb(123, 204, 255)">PIN number</td>
							<td><c:forEach var="card" items="${cardDetails}">
									<input type="text" name="cardpin" value="${card.pin}" readonly>
								</c:forEach></td>
						</tr>
						<tr class="tabhei">
						...
						<tr class="tabhei">
							<td colspan="2" align="center"><input type="submit"
								...
								value="Cancel the card"></td>
						</tr>
					</table>
				</form>
			</td>
			<td align="center"><img src="Images/cancelcard.jpg"
				alt="cancelthebankcard" width="420px"></td>
		</tr>
	</table>
	<br>
	<br>
